...
@section('title', 'Tubular System | Tangga Mas Scaffolding')
...
@section('content')
  ...
  <section class="container mx-auto px-4 pb-16">
    <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-8">Tubular System</h2>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-10">
      ...
      <div class="col-span-full text-center py-16 text-gray-400 bg-brand-gray-bg rounded-xl border border-dashed border-gray-200">
          ...
          <p class="text-sm">Belum ada produk untuk kategori Tubular System.</p>
