...
@php
    // Ambil data banner dari controller
    $categoryBanner = $categoryBanner ?? null;
    $bContent = $categoryBanner?->content ?? [];

    // Safe decode jika tersimpan sebagai JSON string
    ...
    // Judul & Sub-judul Banner
    $catName   = isset($kategoriClean) ? ucfirst($kategoriClean) . ' System' : 'Frame System';
